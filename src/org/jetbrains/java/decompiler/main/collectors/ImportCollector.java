...
public class ImportCollector {
  ...
  public String getShortName(String fullName, boolean imported) {
    ...
    boolean existsDefaultClass = (context.getClass(currentPackageSlash + shortName) != null && !packageName.equals(currentPackagePoint)) || // current package
  ...
  private List<String> packImports() {
    ...
    for (Entry<String, String> ent : lst) {
      ...
      if (!setNotImportedNames.contains(ent.getKey()) && !JAVA_LANG_PACKAGE.equals(ent.getValue()) && !ent.getValue().isEmpty()) {
